...
These snippets use the standard `.pdf` extension and `application/pdf` MIME
type. A real installer should still own the association lifecycle and should
avoid claiming PDFs without an explicit user choice.
